...
void test_pt_no_data()
{
    ...
    std::vector<LineChart::LineChartData> *list = line.get_list();
...
void test_pt_one_cycle()
{
    ...
    TEST_ASSERT_EQUAL(1, list->at(0).data.value);
    TEST_ASSERT_EQUAL(10, list->at(9).data.value);
...
void test_pt_clear()
{
    ...
    /////////////////////////////
    index = 19;
    TEST_ASSERT_EQUAL(10, list->at(index).data.value);
    ...
    /////////////////////////////
    index = 28;
    TEST_ASSERT_EQUAL(9, list->at(index).data.value);
