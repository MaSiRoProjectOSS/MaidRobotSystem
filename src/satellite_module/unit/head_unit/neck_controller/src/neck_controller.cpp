...
int NeckController::_response_pwm_servo_actual(MessageFrame &frame, unsigned int sub_address, int length, int start_index)
{
    bool is_skip = true;
    /*
    | Num    | Device type            | --  | Note |
...
int NeckController::_response_pwm_servo_request(MessageFrame &frame, unsigned int sub_address, int length, int start_index)
{
    bool is_skip = true;
    /*
        | Num    | Device type            | --  | Note          |
...
int NeckController::_response_pwm_servo_setting(MessageFrame &frame, unsigned int sub_address, int length, int start_index)
{
    bool is_skip = true;
    /*
        | Num    | Device type              | --                      | Note |
