...
typedef enum driver_mode
{
    ...
    TORQUE_FROM_DIGITAL,
    TORQUE_FROM_ANALOG,
    POSITION_RELATIVE = POSITION_FROM_PULSE,
    POSITION_ABSOLUTE = POSITION_FROM_DIGITAL,
    VELOCITY          = SPEED_FROM_DIGITAL,
    TORQUE            = TORQUE_FROM_DIGITAL
} DRIVER_MODE;
}; // namespace ZLAC
#endif
