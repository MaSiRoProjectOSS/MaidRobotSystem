 ...
 *
 */
#ifndef COMMON_LOG_CALLBACK_HPP
#define COMMON_LOG_CALLBACK_HPP
...
public:
    ...
    public:
         ...
         */
        log_information(const String func = "", const String path = "", int line = -1)
        {
...
public:
     ...
     */
    typedef std::function<void(OUTPUT_LOG_LEVEL, const String, log_information)> MessageFunction;
#else
    /**
     * @brief Declaration of callbacks
     */
    using MessageFunction = void (*)(OUTPUT_LOG_LEVEL, const String, log_information);
#endif
    /**
...
public:
     ...
     * @param line : file line
     */
    void happened_message(OUTPUT_LOG_LEVEL level, const String message, const String function_name = "", const String file_name = "", int line = 0);
     ...
     * @param line : file line
     */
    void log_trace(const String message, const String function_name = "", const String file_name = "", int line = -1);
    /**
     ...
     * @param line : file line
     */
    void log_debug(const String message, const String function_name = "", const String file_name = "", int line = -1);
    /**
     ...
     * @param line : file line
     */
    void log_info(const String message, const String function_name = "", const String file_name = "", int line = -1);
    /**
     ...
     * @param line : file line
     */
    void log_message(const String message, const String function_name = "", const String file_name = "", int line = -1);
    /**
     ...
     * @param line : file line
     */
    void log_warn(const String message, const String function_name = "", const String file_name = "", int line = -1);
    /**
     ...
     * @param line : file line
     */
    void log_error(const String message, const String function_name = "", const String file_name = "", int line = -1);
    /**
     ...
     * @param line : file line
     */
    void log_fatal(const String message, const String function_name = "", const String file_name = "", int line = -1);
