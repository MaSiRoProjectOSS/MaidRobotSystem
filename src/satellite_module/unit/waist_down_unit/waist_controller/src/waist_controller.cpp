...
// Constructor
// =============================
WaistController::WaistController(HardwareSerial *serial, int pwm_size, int pwm_address) : ModbusLibArduino(serial)
{
...
WaistController::~WaistController(void)
{
...
MessageFrame WaistController::_reception(MessageFrame frame)
{
...
uint32_t WaistController::get_oscillator_frequency(void)
{
    return this->_oscillator_frequency;
}
uint32_t WaistController::get_pwm_freq(void)
{
...
// =============================
int WaistController::_response_accel_and_gyro(MessageFrame &frame, unsigned int sub_address, int length, int start_index)
{
    bool is_skip = true;
    /*
...
// =============================
bool WaistController::_load_setting_setting()
{
    bool result = false;
    try {
...
bool WaistController::_load_setting_setting(fs::FS &fs)
{
    bool result = false;
...
bool WaistController::_save_setting_setting()
{
    bool result = false;
    if (SPIFFS.begin(true)) {
        result = this->_save_setting_setting(SPIFFS);
...
bool WaistController::_save_setting_setting(fs::FS &fs)
{
    bool result   = false;
